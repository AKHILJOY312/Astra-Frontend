...
// import { AdminUserListResult } from "@/domain/repositories/IAdminUserRepository";

// Retrieve all necessary use cases for data fetching and actions
// Note: In a real React app, use a custom hook (e.g., useAdminUserManagement)
// to avoid DI calls outside the component lifecycle.
const listUsersUseCase = container.get<ListUsersUseCase>(
  TYPES.ListUsersUseCase
);
const blockUserUseCase = container.get<BlockUserUseCase>(
  TYPES.BlockUserUseCase
);
const assignRoleUseCase = container.get<AssignAdminRoleUseCase>(
  TYPES.AssignAdminRoleUseCase
);
